...
#ifndef ENCRYPT_AES_SWIFT_H
#define ENCRYPT_AES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="encrypt_AES",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11encrypt_AES11AppDelegate")
...
SWIFT_CLASS("_TtC11encrypt_AES13SceneDelegate")
...
SWIFT_CLASS("_TtC11encrypt_AES14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)encrypt:(id _Nonnull)sender;
- (IBAction)decrypt:(id _Nonnull)sender;
